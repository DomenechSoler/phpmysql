...
$query = 'CREATE TABLE movie (
	...
	movie_name		VARCHAR(255)	NOT NULL, movie_type	TINYINT	NOT NULL DEFAULT 0,
	movie_year	SMALLINT UNSIGNED NOT NULL DEFAULT 0,
	movie_leadactor INTEGER UNSIGNED NOT NULL DEFAULT 0, movie_director INTEGER UNSIGNED NOT NULL DEFAULT 0, 
...
$query = 'CREATE TABLE movietype (
	...
	movietype_label VARCHAR(100)	NOT NULL, PRIMARY KEY (movietype_id)
 ) ENGINE=MyISAM';
mysqli_query($db,$query) or die(mysqli_error($db));
